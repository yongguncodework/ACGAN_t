...
if __name__ == '__main__':
    ...
    y_test_one = labels[0:100, 0:label_dim]
    nb_train, nb_test = X_train.shape[0], X_test.shape[0]
    ...
    for epoch in range(nb_epochs):
        ...
        for index in range(nb_batches):
            ...
            noise = np.random.normal(0, 0.005, (batch_size, latent_size))
            ...
            noise = np.random.normal(0, 0.005, (2 * batch_size, latent_size))
        ...
        # generate a new batch of noise
        noise = np.random.normal(0, 0.005, (nb_test, latent_size))
        ...
        # make new noise
        noise = np.random.normal(0, 0.005, (2 * nb_test, latent_size))
        ...
        noise = np.random.normal(0, 0.005, (16, latent_size))
