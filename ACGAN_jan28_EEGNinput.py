...
if __name__ == '__main__':
    ...
    for epoch in range(nb_epochs):
        ...
        for index in range(nb_batches):
            ...
            for train_ix in range(3):
                if index % 30 != 0:
                    X_real = image_batch
                    # Label Soomthing
                    y_real = np.random.uniform(1, 1.2, size=(batch_size,))
                    ...
                    # Label Soomthing
                    X_fake = generated_images
                    y_fake = np.random.uniform(1, 1.2, size=(batch_size,))
                    aux_y2 = sampled_labels
            ...
            # not-fake
            # trick = np.random.uniform(1, 1.2, size=(2 * batch_size,))
            trick = np.random.uniform(0, 0.7, size=(batch_size,))

            epoch_gen_loss.append(combined.train_on_batch(
                EEG_data_input, [trick, sampled_labels]))
        ...
        # sampled_labels = np.ones(100).reshape(-1, 1)
