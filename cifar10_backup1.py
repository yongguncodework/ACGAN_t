...
if __name__ == '__main__':
    ...
    DATA_FOLDER_PATH = '/media/eeglab/YG_Storage3/ARL_BCIT/Processed_EEG_Data/X2 RSVP Expertise/' \
    ...
    for idx in range(0, 880):
        ...
        batch_files = ['/media/eeglab/YG_Storage3/ARL_BCIT/Processed_EEG_Data/X2 RSVP Expertise/' \
    ...
    if load_weight:
        generator.load_weights('model_save/params_generator_epoch_{0:03d}.hdf5'.format(load_epoch))
        discriminator.load_weights('model_save/params_discriminator_epoch_{0:03d}.hdf5'.format(load_epoch))
    else:
        load_epoch = 0
    ...
    for epoch in range(nb_epochs):
        ...
        generator.save_weights(
            'model_save/params_generator_epoch_{0:03d}.hdf5'.format(load_epoch), True)
        discriminator.save_weights(
            'model_save/params_discriminator_epoch_{0:03d}.hdf5'.format(load_epoch), True)
