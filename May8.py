...
if __name__ == '__main__':
    ...
    for epoch in range(nb_epochs):
        ...
        for index in range(nb_batches):
            ...
            noise = np.random.normal(0, 0.01, (batch_size, latent_size))
            ...
            # sampled_labels = np.random.uniform(-0.3, 0.3, size=(batch_size, 4))
            ...
            noise = np.random.normal(0, 0.01, (2 * batch_size, latent_size))
        ...
        # generate a new batch of noise
        noise = np.random.normal(0, 0.01, (nb_test, latent_size))
        ...
        # make new noise
        noise = np.random.normal(0, 0.01, (2 * nb_test, latent_size))
        ...
        noise = np.random.normal(0, 0.01, (16, latent_size))
        # noise = np.random.uniform(-1, 1, (16, latent_size))
