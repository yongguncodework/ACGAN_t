...
def build_discriminator():
    ...
    label_embedding = Flatten()(Embedding(2, np.prod(img_shape))(label))
    ...
    return Model([image, label], [fake, aux])
...
if __name__ == '__main__':
    ...
    for epoch in range(nb_epochs):
        ...
        for index in range(nb_batches):
            ...
            for train_ix in range(3):
                if index % 30 != 0:
                    ...
                    epoch_disc_loss.append(discriminator.train_on_batch([X_real, label_batch], [y_real, aux_y1]))
                    # Label Soomthing
                    ...
                    epoch_disc_loss.append(discriminator.train_on_batch([X_fake, label_batch], [y_fake, aux_y2]))
                else:
        ...
        X_label = np.concatenate((y_test, sampled_labels))
        ...
        discriminator_test_loss = discriminator.evaluate(
            [X, X_label], [y, aux_y], verbose=False)
