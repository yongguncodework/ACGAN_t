...
if __name__ == '__main__':
    ...
    for epoch in range(nb_epochs):
        ...
        for index in range(nb_batches):
            ...
            sampled_labels = np.random.uniform(-1, 0.6, size=(batch_size, 4))
            ...
            sampled_labels = np.random.uniform(-1, 0.6, size=(2 * batch_size, 4))
        ...
        sampled_labels_disc = to_categorical(sampled_labels_disc, label_dim)
        sampled_labels = np.random.uniform(-1, 0.6, size=(nb_test, 4))
        generated_images = generator.predict(
        ...
        # sampled_labels = to_categorical(sampled_labels, label_dim)
        sampled_labels = np.random.uniform(-1, 0.6, size=(2 * nb_test, 4))
