...
if __name__ == '__main__':
    ...
    for epoch in range(nb_epochs):
        ...
        for index in range(nb_batches):
            ...
            stepone = index+1
            For_combining_noise = FeatureV[index*batch_size:stepone*batch_size, :]
            noise[0:16, 106:110] = For_combining_noise
            # noise[index * batch_size:stepone * batch_size, latent_size - 4:latent_size] = For_combining_noise
            ...
            For_combining_noise2 = FeatureV[0*batch_size:1*batch_size, :]
            noise[0:16, 106:110] = For_combining_noise2
        ...
        For_combining_noise3 = FeatureV[0 * nb_test:1 * nb_test, :]
        noise[0 * nb_test:1 * nb_test, latent_size - 4:latent_size] = For_combining_noise3
        ...
        For_combining_noise4 = FeatureV[0 * nb_test:1 * nb_test, :]
        noise[0 * nb_test:1 * nb_test, latent_size - 4:latent_size] = For_combining_noise4
        ...
        For_combining_noise5 = FeatureV[0 * batch_size:1 * batch_size, :]
        noise[0:16, 106:110] = For_combining_noise5
